...
// New function to compute the Mel Spectrogram
...
// Modified function to compute MFCC from Mel Spectrogram
int compute_mfcc(mfcc_params* params, const double* audio_buffer, size_t buffer_len, double* mfcc_output) {
    ...
    // 1. Get the mel spectrogram first
    ...
    // 2. Process the spectrogram to get MFCCs
