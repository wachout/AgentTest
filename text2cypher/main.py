...
prompt_generate_query = ChatPromptTemplate.from_messages(
    [
        ("system",
         ...
         "2. **CRITICAL RULE on Return Values**: The `RETURN` clause of the query MUST ALWAYS include the `source_id` of the relevant nodes (e.g., `start_node.source_id`, `end_node.source_id`).\n"
         ...
         "Generated Cypher: MATCH (start_node)-[r]-(end_node) WHERE start_node.entity_id = 'Tidal Force' AND end_node.entity_id = 'Earth Engine' RETURN start_node.entity_id, start_node.source_id, type(r), end_node.entity_id, end_node.source_id\n"
         "---"
         "Example 2: User wants to know more about 'Helium Flash'.\n"
         "Nodes: ['Helium Flash']\n"
         "Query: 'Tell me about Helium Flash'\n"
         "Generated Cypher: MATCH (start_node) WHERE start_node.entity_id = 'Helium Flash' RETURN start_node.description, start_node.source_id"
        ),
        ("human",
